...
Future<void> registerBlocModule(GetIt injector) async {
  ...
  injector.registerFactory(() => GroupDetailsCubit(injector.get(), injector.get(), injector.get(), injector.get(), injector.get()));
  injector.registerFactory(() => GroupPickerCubit(injector.get()));
  injector.registerFactory(() => ShareGroupCubit(injector.get()));
